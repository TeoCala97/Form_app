# Generated by Django 4.0.5 on 2022-10-21 20:16
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Form', '0005_alter_forms_api_nombre_campo_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='forms_api',
            name='Tipo_usuario',
            field=models.CharField(choices=[('', ''), ('ONLINE', 'ONLINE'), ('HARD', 'HARD'), ('SOFT', 'SOFT'), ('TODOS', 'TODOS'), ('ACABADOS', 'ACABADOS'), ('MIX', 'MIX')], default=None, max_length=10, verbose_name='Tipo de Usuario'),
        ),
        migrations.AlterField(
            model_name='forms_api',
            name='Valor_Campo',
